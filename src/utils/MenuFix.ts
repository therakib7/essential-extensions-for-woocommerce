export const essential_extensions_wcSlug = 'essential-extensions-for-woocommerce';
...
export function menuFix() {
    ...
    const menuRoot = $('#toplevel_page_' + essential_extensions_wcSlug);
    ...
    $('ul.wp-submenu a', menuRoot).each(function (index: number, el: any) {
        const routeName: string =
            typeof navRoutes[1] !== 'undefined' ? navRoutes[1] : ''; // eslint-disable-line
        let isActive = false;
