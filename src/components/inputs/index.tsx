...
export function Input(props: InputProps) {
    ...
    const getClassName = () => {
        let classNames = `bg-white text-black placeholder:text-placeholder transition px-4 rounded-md placeholder:font-normal text-sm border border-b border-solid border-slate-300 border-outline-none !shadow-none focus:!outline-none focus:!border-[#EBEFF8] focus:!shadow-[#EBEFF8] required:border-red-500 w-full`;
    ...
    const printErrorMessage = () => {
        if (hasError && showErrorMessage && errorMessage?.length > 0) {
            return <p className="text-error text-xs mt-2">{errorMessage}</p>;
        }
    };
