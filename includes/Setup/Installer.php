...
namespace EssentialExtensionsWC\Setup;
...
class Installer {
    ...
    public function run(): void {
        ...
        if ( version_compare( $version, ESSENTIAL_EXTENSIONS_WC_VERSION, '<' ) ) {
    ...
    public function add_version(): void {
        ...
        update_option( Keys::VERSION, ESSENTIAL_EXTENSIONS_WC_VERSION );
    }
