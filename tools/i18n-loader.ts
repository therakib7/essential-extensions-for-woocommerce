...
class I18nLoader {
    constructor() {
        // @ts-ignore
        this.state = window.essential_extensions_wcI18nState;
    }
...
// Register the module
const essential_extensions_wcI18nLoader = new I18nLoader();
(window as any).essential_extensions_wcI18nLoader = essential_extensions_wcI18nLoader;
